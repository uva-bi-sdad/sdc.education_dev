...
dat20172019 <- dat %>% filter(year %in% c(2017, 2018, 2019)) %>% mutate(measure='years of schooling', measure_type = "index") %>% select(geoid, year, measure, measure_type, value)
dat20202021 <- dat %>% filter(year %in% c(2020, 2021)) %>% mutate(measure='years of schooling', measure_type = "index") %>% select(geoid, year, measure, measure_type, value)
