...
tr_ct$measure <- "average_years_schooling"

readr::write_csv(tr_ct, xzfile('Years of Schooling/data/working/va_trct_acs5_2015_2021_years_of_schooling_2.csv'))
...
## convert
rcsv <- read.csv(xzfile("Years of Schooling/data/working/va_trct_acs5_2015_2021_years_of_schooling_2.csv", open = "r"), colClasses = c("character", "integer", "logical", "numeric", "character"))
stnd <- standardize_all(rcsv)

# save standardized file
write.csv(stnd, file = xzfile("Years of Schooling/data/distribution/va_trct_acs5_2015_2021_years_of_schooling_std.csv", compression = 9), row.names = FALSE)
